...
public class MovieReviewCommonMapper implements RowMapper {
    @Override
    public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
        MovieReviewCommon movieCommon =new MovieReviewCommon();
        ...
        movieCommon.setAvgOverall(rs.getFloat("avg_overall"));
